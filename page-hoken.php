							...
							<div class="l-container3 l-hoken-sec__hiyo p-hoken-sec__hiyo">
								...
								<div class="p-hoken-sec__hiyo__txt">
									...
									<ul class="p-hoken-sec__hiyo__txt__note-list">
										...
										<li class="p-hoken-sec__hiyo__txt__note-list__item c-description__note -kome">高額療養費制度の対象となります。詳細については病院の会計窓口でご相談ください。</li>
									</ul>
								</div>
							</div>
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc01-04">
								...
								<div class="c-txtbox">
									...
									<div class="p-hoken-sec__description__sinryojikan">
										...
										<ul class="p-hoken-sec__description__sinryojikan__list">
											...
											<li class="p-hoken-sec__description__sinryojikan__list__item">金曜日 13:00-15:30 (最終受付 15:00)</li>
										</ul>
									</div>
								</div>
							</div>
