      ...
      <div class="l-container">
				<section class="l-common-sec">
					<h1 class="c-head-title l-head-title l-hoken-head-title">
						<span class="c-head-title__char -navy"><span class="c-head-title__char__inner">保</span></span>
						<span class="c-head-title__char -navy"><span class="c-head-title__char__inner">険</span></span>
						<span class="c-head-title__char -navy-frame"><span class="c-head-title__char__inner">診</span></span>
						<span class="c-head-title__char -navy-frame"><span class="c-head-title__char__inner">療</span></span>
					</h1>
					<div class="c-contents">
						<section class="l-hoken-description">
							<p class="l-hoken-description__txt">2019年6月に保険診療下でのがん遺伝子パネル検査がスタートしました。<br>2023年1月現在、当院で行っている保険診療のがん遺伝子パネル検査は3種類あります。<br>どの検査が最適であるかは、担当医が患者さんの状態を診て判断します。</p>
							...
							<div class="l-container3 l-hoken-sec__hiyo p-hoken-sec__hiyo">
								...
								<div class="p-hoken-sec__hiyo__txt">
									...
									<ul class="p-hoken-sec__hiyo__txt__note-list">
										<li class="p-hoken-sec__hiyo__txt__note-list__item c-description__note -kome">その他、検体の準備などの費用が追加で必要となります。</li>
										<li class="p-hoken-sec__hiyo__txt__note-list__item c-description__note -kome">高額療養費制度の対象となる場合がありますので、病院の会計窓口でご相談ください。</li>
									</ul>
								</div>
							</div>
						</section>
						<section class="l-hoken-sec -sec02">
							...
							<div class="l-container2">
								<ul class="p-hoken-sec__taisyo__list">
									...
									<li class="c-list__item p-hoken-sec__taisyo__list__item">がん遺伝子パネル検査後に薬物療法の適応となる可能性が高いと主治医が判断した方</li>
								</ul>
								<ul class="p-hoken-sec__hiyo__txt__note-list">
						...
						<section class="l-hoken-sec p-hoken-sec -sec03">
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc03-02">
								<div class="c-txtbox">
									...
									<p class="p-hoken-sec__description__txt">指定された日時に「<span class="u-txt-point">慶應義塾大学病院 セカンドオピニオン外来</span>」にお越しください。<br>検査の説明と医師による診察を行います。</p>
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc03-03">
								<div class="c-txtbox">
									...
									<p class="p-hoken-sec__description__txt">指定された日時に「<span class="u-txt-point">慶應義塾大学病院 がん遺伝子外来</span>」にお越しください。<br>検査について説明文書を用いて説明します。説明後、検査に同意される場合は同意書にご署名いただきます。<br>同意取得後に検査開始となります。当院より病理検体や血液を検査センターへ郵送し、がん遺伝子パネル検査を行います。</p>
									...
									<div class="p-hoken-sec__description__sinryojikan">
										...
										<ul class="p-hoken-sec__description__sinryojikan__list">
											<li class="p-hoken-sec__description__sinryojikan__list__item">火曜日 14:00-16:30 (最終受付 16:00)</li>
											<li class="p-hoken-sec__description__sinryojikan__list__item">木曜日 13:30-16:00 (最終受付 15:30)</li>
											<li class="p-hoken-sec__description__sinryojikan__list__item">金曜日 13:30-16:00 (最終受付 15:30)</li>
										</ul>
									</div>
								</div>
							</div>
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc03-04">
								<div class="c-txtbox">
									...
									<p class="p-hoken-sec__description__txt">検査申し込み日より<span class="u-txt-point">4～6週間後</span>に、当院の担当医師からがん遺伝子パネル検査の結果説明と推奨治療の提示を行います。</p>
