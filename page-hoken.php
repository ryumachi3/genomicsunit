				...
				<section class="l-common-sec">
					...
					<div class="c-contents">
						<section class="l-hoken-description">
							<p class="l-hoken-description__txt">2019年6月に保険診療下でのがん遺伝子パネル検査がスタートしました。<br>現在、当院で行っている保険診療のがん遺伝子パネル検査は5種類あります。</p>
						...
						<section class="l-hoken-sec p-hoken-sec -sec03">
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc03-01">
								<div class="c-txtbox">
									...
									<div class="p-hoken-sec__description__sinryojikan">
										<h4 class="p-hoken-sec__description__sinryojikan__title">
											＜がん遺伝子外来の保険診療時間＞<br>
											・ 火曜日午後<br>
											・ 金曜日午後
										</h4>
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc03-02">
								<div class="c-txtbox">
									...
									<p class="p-hoken-sec__description__txt">
										指定された日時に
										「<span class="u-txt-point">慶應義塾大学病院 セカンドオピニオン外来</span>」にお越しください。<br>
										医師により検査の説明を行います。
								    </p>
