      ...
      <div class="l-container">
				...
				<h1 class="c-head-title__wrap l-head-title l-iryo-head-title">
					...
					<section class="l-about-main">
						...
						<h2 class="c-title l-about-main__title"><span class="c-title__line-tate"></span><span class="c-title__line-yoko"></span>がん遺伝子検査が身近なものに</h2>
						<div class="l-container3 l-about-main__description p-about-main__description -desc02">
							<div class="c-txtbox">														
								<p class="l-about-main__description__txt">がんの発症に強く関連する遺伝子はこれまでに数百種類見つかっています。それらの遺伝子に変化がないかどうかを調べるのが「がん遺伝子検査」です。以前はひとつひとつの遺伝子を調べるために膨大な時間がかかっていましたが、次世代シークエンサーという解析装置を使って<span class="u-txt-point">一度に複数の遺伝子を調べることができる「がん遺伝子パネル検査」</span>が登場し、がん遺伝子検査が数週間でできるようになりました。また、<span class="u-txt-point">保険診療でできるがん遺伝子パネル検査</span>も登場し、費用的にも身近なものになってきました。</p>
							</div>
