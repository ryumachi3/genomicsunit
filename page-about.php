      ...
      <div class="l-container">
				...
				<h1 class="c-head-title__wrap l-head-title l-iryo-head-title">
					...
					<section class="l-about-main">
						...
						<h2 class="c-title l-about-main__title">がん遺伝子検査が身近なものに</h2>
						...
						<h2 class="c-title l-about-main__title">なぜパネル検査をするのか</h2>
						...
						<h2 class="c-title l-about-main__title">ゲノム医療ユニットについて</h2>
