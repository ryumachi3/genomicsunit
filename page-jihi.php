					...
					<div class="c-contents">
						...
						<section class="l-hoken-sec p-hoken-sec -sec01">
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc01-05">
								<div class="c-txtbox">
									<p class="l-about-main__description__txt">PleSSision検査について詳しく知りたい方は、<a href="https://youtu.be/4s9j6Piyw3E?si=cEld1P7NPYcNzWH-" target="_blank" rel="noopener noreferrer" class="u-under-line u-txt-point u-external-link">がん遺伝子解析サービス導入事例インタビュー</a>もあわせてご覧ください。</p>
								</div>
							</div>
						</section>
