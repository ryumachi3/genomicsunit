				...
				<section class="l-common-sec">
					...
					<div class="c-contents">
						<section class="l-jihi-description">
							<p class="l-hoken-description__txt"><span class="u-txt-point">保険診療を受けられない</span>患者さん、<span class="u-txt-point">より詳しい検査をしたい</span>患者さん、<span class="u-txt-point">結果を早く知りたい</span>患者さんには自費診療も紹介しています。<br>2023年8月現在、当院で行っている自費診療のがん遺伝子検査は4種類あります。</p>
						...
						<section class="l-hoken-sec p-hoken-sec -sec01">
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc01-01">
								<div class="c-txtbox">
									...
									<p class="p-hoken-sec__description__txt">がんに関連した<span class="u-txt-point">145遺伝子</span>について、<span class="u-txt-point">がん組織</span>と<span class="u-txt-point">血液</span>の両方で調べます。病理医が精度管理することにより、がんの組織から採取した<span class="u-txt-point">検体が少量の場合でも</span>遺伝子解析が可能です。</p>
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc01-04">
								<div class="c-txtbox">
									<h3 class="p-hoken-sec__description__title">Guardant Reveal(ガーダント リビール)</h3>
									<p class="p-hoken-sec__description__txt">血液中の血中循環腫腫瘍DNAから、がんの遺伝子異常を検出するシステムです。</p>
									<dl class="p-jihi-sec__description__hiyo">
										<dt class="p-jihi-sec__description__hiyo__title c-hiyo-title">検査費用</dt><dd class="p-jihi-sec__description__hiyo__txt"><span class="p-jihi-sec__description__hiyo__price">380,000</span>円(税込)<dd>
									</dl>
									<dl class="p-jihi-sec__description__kekka">
										<dt class="p-jihi-sec__description__kekka__title c-kekka-title">結果がわかるまで</dt><dd class="p-jihi-sec__description__kekka__txt">約<span class="p-jihi-sec__description__kekka__num">3</span>週間<dd>
									</dl>
							...
							<div class="l-container3 l-hoken-sec__description p-hoken-sec__description -desc01-05">
								<div class="c-txtbox">
									<p class="l-about-main__description__txt">プレシジョン検査について詳しく知りたい方は、<a href="https://youtu.be/4s9j6Piyw3E?si=cEld1P7NPYcNzWH-" target="_blank" rel="noopener noreferrer" class="u-under-line u-txt-point u-external-link">がん遺伝子解析サービス導入事例インタビュー</a>もあわせてご覧ください。</p>
								</div>
							</div>
						</section>
