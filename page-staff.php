      ...
      <div class="l-container -staff">
				<section class="l-common-sec">
					<h1 class="c-head-title l-head-title l-staff-head-title">
						<span class="c-head-title__char -navy">ス</span>
						<span class="c-head-title__char -navy">タ</span>
						<span class="c-head-title__char -navy">ッ</span>
						<span class="c-head-title__char -navy">フ</span>
						<span class="c-head-title__char -navy-frame">紹</span>
						<span class="c-head-title__char -navy-frame">介</span>
					</h1>
					...
					<section class="l-doctor-sec p-doctor-sec -sec01">
						<h2 class="c-title l-doctor-sec__title">医師</h2>
						<ul class="p-doctor-sec__list">
							...
							<li class="p-doctor-sec__list__item">
								<div data-fancybox="gallery"  data-src="#modal_doctor_002" class="p-doctor-sec__list__item__link">
									...
									<div class="modal" id="modal_doctor_002">
										<img src="<?php echo get_theme_file_uri() ?>/img/photo_doctor_hayashi.jpg" alt="" class="p-doctor-sec__list__item__img">
									</div>
								</div>
							</li>
							...
							<!-- <li class="p-doctor-sec__list__item">
								<a data-fancybox="gallery" data-src="#modal_doctor_001" href="javascript:;" class="p-doctor-sec__list__item__link">
									<div class="p-doctor-sec__list__item__img__wrap">
										<img src="<?php echo get_theme_file_uri() ?>/img/photo_doctor_hayashi.jpg" alt="" class="p-doctor-sec__list__item__img">
									</div>
									<div class="p-doctor-sec__list__item__info">
					...
					<section class="l-staff-sec p-staff-sec -sec02">
						<h2 class="c-title l-staff-sec__title">スタッフ・共同研究員</h2>
