				...
				<section class="l-common-sec">
					...
					<div class="c-contents">
						<section class="l-rinsyo-description">
							<p class="l-rinsyo-description__txt">慶應義塾大学病院腫瘍センターゲノム医療ユニットでは研究機関として、今後の医療の発展に役立て、患者さんの生活の質の向上を目指し、様々な臨床・基礎研究を実施しております。<span class="u-txt-point">患者さんの診療に直接影響しない下記の研究に関して、主に手術検体等の臨床検体や診療録のデータを集積・解析して研究を行っております。</span><br>
								当院の倫理委員会の承認の下、国が定まる指針等を遵守し、患者さんの安全性やプライバシーに充分配慮した上で実施しております。これらのデータを学会発表や論文の発表に貴重なデータとして利用させていただくことがございます。ご理解、ご協力のほどよろしくお願いいたします。なお、<span class="u-txt-point">下記の研究へのご協力を希望されない場合は、担当医もしくはゲノム医療ユニットまでお知らせください。</span></p>
